...
## What the P-4 purchaser field means

The RRC's [About Oil & Gas Data Queries](https://www.rrc.texas.gov/resource-center/research/research-queries/about-oil-gas-data-queries/) describes the P-4 `Gatherer` as the company designated to transport product off the lease and the `Purchaser` as the company designated to buy that product first. Its [P-4 instructions](https://www.rrc.texas.gov/media/kx0hcdrw/p-4-ins.pdf) describe the form as an operator filing used to identify authorized gatherers and purchasers for a well or lease. Those are regulatory and product-sale fields.

The [P-4 Gatherer/Purchaser Query](https://webapps2.rrc.texas.gov/EWA/gathererPurchaserQueryAction.do) can be searched by such locators as district, oil lease number or gas-well ID, operator, gatherer or purchaser, and product. Preserve the exact field label, record identifier, product, retrieval date and any displayed status. Do not assume that an oil-purchaser line also describes a casinghead-gas line or every period on a private statement. The companion [P-4 query provenance worksheet](/blog/texas-rrc-p-4-gatherer-purchaser-query-retrieval-provenance-worksheet/) covers how to record one actual query attempt without interpreting the result.

## What `payor` means on the royalty side

[Texas Natural Resources Code §91.401(2)](https://tcss.legis.texas.gov/resources/NR/htm/NR.91.htm) defines the payor by the undertaking to distribute production-sale proceeds to the payee. Its wording includes a purchaser, an operator, or a lessee, and describes the first-purchaser default with a stated exception for an arrangement with the party holding the right to produce. So the safe answer is neither “the P-4 purchaser always pays my royalties” nor “the purchaser never does.” The relevant arrangement, property and owner-account records matter.
