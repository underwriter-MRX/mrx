...
inline_image:
  ...
  height: 675
  mime_type: 'image/webp'
  prompt: 'Distinct MRX-owned in-body evidence composition with deterministic exact-keyword text: title defects mineral rights offer'
  source: 'MRX-owned AI-generated distinct evidence composition via built-in image generation on 2026-09-15'
  license: 'MRX-owned'
  perceptual_hash: ''
...
faq:
  ...
  - question: 'Who can address a disputed title or contract conclusion?'
    answer: 'A qualified title professional or attorney can address ownership, record sufficiency, deed language, and contract rights for the specific facts and jurisdiction.'
