...
inline_image:
  ...
  height: 675
  mime_type: 'image/webp'
  prompt: 'Distinct MRX-owned in-body evidence composition with deterministic exact-keyword text: why did my mineral royalty check go down'
  source: 'MRX-owned AI-generated distinct evidence composition via built-in image generation on 2026-09-15'
  license: 'MRX-owned'
  perceptual_hash: ''
...
sources:
  ...
  - label: 'U.S. Energy Information Administration: Natural Gas Data'
...
faq:
  ...
  - question: 'How many royalty statements should I compare?'
    answer: 'Compare several consecutive statements when available so a one-time timing adjustment or correction is not mistaken for a sustained production, price, deduction, or ownership change.'
