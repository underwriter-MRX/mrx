...
const EXPECTED_CANONICAL_JSON_SHA256 =
  '97c080482e25676b730ebee62597fcdf6a555b28d68fc150b9a24caf1e823dd6';
const EXPECTED_CANONICAL_CSV_SHA256 =
  '0ac3e3ea4f1316e3154c0faa120090d031105c401065c28f790fe4771f82bcef';
...
describe('MRX1000 canonical ledger generator (pilot-aware + idempotent)', () => {
  ...
  it('preserves post-Wave-99 rekeys and restores displaced planning identities', () => {
    ...
    expect(
      bySlug.get('midland-cad-2026-certified-mineral-roll-zip-file-order-formats-privacy-limits')
        ?.program_row_id,
    ).toBe('MRX1000-0832');
    expect(
    ...
    expect(
      bySlug.get('pecos-cad-2025-2026-reappraisal-plan-category-g-parcel-counts-by-isd')
        ?.program_row_id,
    ).toBe('MRX1000-0835');
    expect(
    ...
    expect(
      bySlug.get('pecos-cad-oil-and-gas-review-infrequent-sales-and-multi-site-limits')
        ?.program_row_id,
    ).toBe('MRX1000-0837');
    expect(
    ...
    expect(
      bySlug.has('midland-county-texas-mineral-rights-value-valuation-factors-without-obligation'),
    ).toBe(false);
    expect(
    ...
    expect(
      bySlug.has('pecos-county-texas-mineral-rights-value-market-update-for-mineral-owners'),
    ).toBe(false);
    expect(bySlug.has('pecos-county-texas-mineral-rights-value-risk-checklist-in-2026')).toBe(
      false,
    );
